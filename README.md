...
document.getElementById("percent").innerHTML="%"+chance;
...
msg.innerHTML=texts[Math.floor(chance/20)-1];

}else{

msg.innerHTML="🎉 Tebrikler! Sevgili tarafından affedildin.<br><br>Ödülün: Sonsuz sarılma ❤️";
}
